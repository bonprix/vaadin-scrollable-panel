...
public class DemoUI extends UI {
    ...
    @VaadinServletConfiguration(
        ...
        ui = DemoUI.class,
        widgetset = "org.vaadin.addons.scrollablepanel.demo.DemoWidgetSet")
    ...
    protected void init(final VaadinRequest request) {
        ...
        scrollTopSlider.addValueChangeListener(new ValueChangeListener<Double>() {

            @Override
            public void valueChange(final ValueChangeEvent<Double> event) {
                final int scrollTop = scrollTopSlider.getValue()
                    .intValue();
                final int scrollLeft = scrollLeftSlider.getValue()
                    .intValue();
        ...
        scrollLeftSlider.addValueChangeListener(new ValueChangeListener<Double>() {
        ...
        final Label scrollTopLabel = DemoUI.createCaptionLabel("Top scroll position:");
        final Label scrollLeftLabel = DemoUI.createCaptionLabel("Left scroll position:");
        final Label scrollRightLabel = DemoUI.createCaptionLabel("Right scroll position:");
        final Label scrollBottomLabel = DemoUI.createCaptionLabel("Bottom scroll position:");
        final Label scrollWidthLabel = DemoUI.createCaptionLabel("Width of scrolling area:");
        final Label scrollHeightLabel = DemoUI.createCaptionLabel("Height of scrolling area:");
        ...
        scrollablePanel.addScrollListener(new ScrollListener() {
            ...
            public void onScroll(final ScrollEvent event) {
                ...
                scrollRightLabel.setValue(Integer.toString(event.getScrollData()
                    .getRight()));
                scrollBottomLabel.setValue(Integer.toString(event.getScrollData()
                    .getBottom()));
